...
public class RiseAndLowerScriptBoss : MonoBehaviour {

	//The code causes the object it is placed on to move up and down.
	//I use this code for some of the boss AI in order to make the boss move in a circular motion.
	...
	public float rightLeftRange = 10;
	...
	void Update () {
		float x = rightLeftRange * Mathf.Cos(Time.timeSinceLevelLoad) + startPosition.x;
