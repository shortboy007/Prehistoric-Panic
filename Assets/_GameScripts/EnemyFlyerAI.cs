...
public class EnemyFlyerAI : MonoBehaviour
{
    ...
    //This boss controls the enemy AI in the game for flying enemies. I have a script for ground enemies as well. It is the same except that the ground units are stationary.
