...
public class BattleHandlerSoldierCaveman1Backup : MonoBehaviour
{
    ...
    void chooseTag()
    {
        var chooseSoldierTag = Random.Range(0, 5);
            ...
            {
                gameObject.tag = "Army1-Soldier1";
            }

            if (chooseSoldierTag == 1)
            {
                gameObject.tag = "Army1-Soldier2";
            }

            if (chooseSoldierTag == 2)
            {
                gameObject.tag = "Army1-Soldier3";
            }

            if (chooseSoldierTag == 3)
            {
                gameObject.tag = "Army1-Soldier4";
            }

            if (chooseSoldierTag == 4)
            {
                gameObject.tag = "Army1-Soldier5";
            }
        }
    ...
    void chooseInitialTarget()
    {
        ...
        void Update()
    {
        soldier1 = GameObject.FindWithTag("Army1-Soldier1");
        soldier2 = GameObject.FindWithTag("Army1-Soldier2");
        soldier3 = GameObject.FindWithTag("Army1-Soldier3");
        soldier4 = GameObject.FindWithTag("Army1-Soldier4");
        soldier5 = GameObject.FindWithTag("Army1-Soldier5");

        enemy1 = GameObject.FindWithTag("Army2-Soldier1");
        enemy2 = GameObject.FindWithTag("Army2-Soldier2");
        enemy3 = GameObject.FindWithTag("Army2-Soldier3");
        enemy4 = GameObject.FindWithTag("Army2-Soldier4");
        enemy5 = GameObject.FindWithTag("Army2-Soldier5");
